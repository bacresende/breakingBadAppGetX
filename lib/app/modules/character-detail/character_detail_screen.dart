              ...
              [
                Container(
                  ...
                  child: Column(
                    ...
                    children: [
                      CharacterInfo(title: 'Job : ', join: controller.character.jobs.join(' / ')),
                      BuildDivider(endIndent: 315),

                      CharacterInfo(title: 'Appeared in : ', join: controller.character.categoryForTwoSeries),
                      BuildDivider(endIndent: 250),

                      CharacterInfo(title: 'Seasons : ', join: controller.character.appearanceOfSeasons.join(' / ')),
                      BuildDivider(endIndent: 280),

                      CharacterInfo(title: 'Status : ', join: controller.character.statusIfDeadOrAlive),
                      ...
                      controller.character.betterCallSaulAppearance.isEmpty
                          ...
                          : CharacterInfo(
                              ...
                              join: controller.character.betterCallSaulAppearance.join(" / ")),

                      controller.character.betterCallSaulAppearance.isEmpty
                          ? Container()
                          : BuildDivider(endIndent: 150),
                          
                      CharacterInfo(title: 'Actor/Actress : ', join: controller.character.acotrName),
